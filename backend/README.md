...
## Project Structure
    ...
    ├── testapiautostorybo_110863  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_110863`
...
2. Clone this repo and `cd testapiautostorybo_110863`
